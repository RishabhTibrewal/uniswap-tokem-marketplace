...
const HeroSection = () => {
  ...
  <section className="bg-[#1A1A1A] text-gray-100">
    ...
    lg:py-24 lg:flex-row lg:justify-between">
      <div className="flex flex flex-col justify-center p-6 text-center rounded-sm
      lg:ma-w-md xl:max-w-lg lg:text-left">
        ...
        <p className="mt-6 mb-8 text-lg sm:mb-12">
          ...
          turpis pulviner, est scelerisque ligula sem
        </p>
