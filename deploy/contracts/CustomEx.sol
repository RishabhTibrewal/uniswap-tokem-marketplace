...
contract CustomDex{
    ...
    function swapTokenToToken(string memory tokenName, uint256 _amount) public returns(uint256) {
    ...
    function swapTokenToToken(string memory srcTokenName, string memory dstTokenName, uint256 _amount )public {
        ...
        _transactionHistory(srcTokenName, dstTokenName, _amount, _amount);
